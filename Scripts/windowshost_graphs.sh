...
############################################################
for arq in `cat /home/see/NMSeePlusv4.2_env/TempGraphId/Windows/cpu_utilization.txt `; do
  cpu_graphid=$arq
done
...
for arq2 in `cat /home/see/NMSeePlusv4.2_env/TempGraphId/Windows/memory_usage.txt `; do
  mem_graphid=$arq2
done
